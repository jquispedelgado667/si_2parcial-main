<x-app-layout>
    ...
    <div class="py-8 sm:py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <!-- Bienvenida Mejorada -->
            <div class="bg-gradient-to-r from-emerald-600 via-teal-700 to-emerald-900 overflow-hidden shadow-xl rounded-2xl p-8 mb-8 relative">
                <div class="absolute top-0 right-0 -mt-4 -mr-4 h-32 w-32 bg-emerald-500 rounded-full opacity-20 blur-3xl"></div>
                <div class="absolute bottom-0 left-0 -mb-4 -ml-4 h-24 w-24 bg-teal-600 rounded-full opacity-20 blur-2xl"></div>
                ...
                <div class="relative z-10">
                    <div class="flex items-center space-x-3 mb-3">
                        ...
                        <div>
                            ...
                            <p class="text-emerald-200 mt-1">Facultad de Ingeniería en Ciencias de la Computación y TelecomunicacionesFacultad - FICCT</p>
                        </div>
                    </div>
                    <div class="mt-4 flex items-center space-x-2 text-emerald-200 text-sm">
